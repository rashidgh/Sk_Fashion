    ...
    <section className={styles.NavBarBlock} id="navbarBlock">
      <article>
        <div className={styles.div1}>
          <Link to="/">
            <img src={skLogo} alt="LOGO" style={{ height: "60px" }} />
